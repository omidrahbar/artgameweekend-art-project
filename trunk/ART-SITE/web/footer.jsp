    ...
    <div id="footer-outer" class="clear"><div id="footer-wrap">
            ...
            <div class="col-a">
                ...
                <div class="footer-list">
                    <ul>
                        <li><a href="best.jsp" >Best rated</a></li>
                        <li><a href="latest.jsp" >Latest</a></li>
                        <li><a href="map.jsp" >World Map</a></li>
            ...
            <div class="col-b">
                <h3>About Us</h3>
                <p>
                    <a href="team.jsp" >Meet the team</a>
                </p>
            </div>
            ...
            <div id="footer-bottom">
                ...
                <div class="bottom-left">
                    <p>
                        &copy; 2010-2011 <strong>Copyright artags.org</strong>&nbsp; &nbsp; &nbsp;
                </div>
...
<script type="text/javascript">
    ...
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-18687706-1']);
